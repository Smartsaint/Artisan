    ...
    <div class="flex flex-col md:flex-row rounded-lg overflow-hidden max-w-7xl w-full">
        <div class="w-full md:w-1/2 p-4 flex justify-center">
            <div class="w-full md:w-2/3">
                <h2 class="text-3xl font-semibold text-purple-700 mb-7">Login</h2>
                <form action="#" method="POST">
                    ...
                    <div class="mb-4">
                        <button type="submit" class="px-20 py-2 bg-purple-700 text-white font-semibold rounded-3xl w-full">Login</button>
                    </div>
                    <div class="mb-4">
