        ...
        <div class="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          ...
          <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
            <form class="ml-auto ">
              ...
              <div
  class="flex p-3 border border-gray-100 rounded-full sm:items-center sm:gap-4"
>
  <input
    type="email"
    id="UserEmail"
    placeholder="Enter your email address..."
    class="w-full text-white placeholder-gray-500 bg-gray-900 border-none rounded-full sm:text-sm"
  />

  <button
    class="px-6 py-3 mt-1 text-sm font-bold text-white uppercase transition-none rounded-full bg-star hover:bg-teal-600 sm:mt-0 sm:shrink-0"
  >
  SUBSCRIBE  </button>
</div>
          ...
          <ul class="flex justify-start col-span-2 gap-6 lg:col-span-5 ">
            <li>
              <a
                href="#"
                rel="noreferrer"
