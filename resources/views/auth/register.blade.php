    ...
    <div class="flex flex-col md:flex-row rounded-lg overflow-hidden max-w-7xl w-full">
        <div class="w-full md:w-1/2 p-4 flex justify-center">
            <div class="w-full md:w-2/3">
                <h2 class="text-3xl font-semibold text-purple-700 mb-7">Register</h2>
                <form action="#" method="POST">
                    ...
                    <div class="mb-10 flex justify-between items-center">
                        <a href="#" class="text-sm hover:underline">
                            ...
                            <span class="text-purple-700">Click here</span>
                        </a>
                    </div>
                    <div class="mb-4">
                        <button type="submit" class="px-20 py-2 w-full bg-purple-700 text-white font-semibold rounded-3xl">Login</button>
                    </div>
                    <div class="mb-4">
                        <button type="button" class="w-full px-4 py-2 bg-white border border-gray-300 text-gray-700 font-semibold flex items-center justify-center rounded-3xl">
                            <img src="{{ asset('images/Google_icon.png') }}" alt="Google" class="h-6 w-6 mr-2">
                            Signup with Google
                        </button>
                    </div>
                    <div class="text-sm">
                        <p>
                            ...
                            <a href="#" class="text-purple-700 hover:underline">Register here.</a>
                        </p>
                    </div>
                </form>
            </div>
