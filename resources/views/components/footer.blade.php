      ...
      <div class="lg:flex lg:items-start lg:gap-8">
        ...
        <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          <div class="col-span-2">
            <div>
              <h2 class="text-2xl font-bold text-white">Don’t miss our weekly updates about freelancer career</h2>
          ...
          <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
            <form class=" ml-auto">
              ...
              <div
  class="border rounded-full border-gray-100 p-3 flex  sm:items-center sm:gap-4"
>
  <input
    type="email"
    id="UserEmail"
    placeholder="Enter your email address..."
    class="w-full rounded-full border-none  bg-gray-900 text-white placeholder-gray-500 sm:text-sm"
  />

  <button
    class="mt-1 rounded-full  bg-star px-6 py-3 text-sm font-bold uppercase  text-white transition-none hover:bg-teal-600 sm:mt-0  sm:shrink-0"
  >
  SUBSCRIBE  </button>
</div>
          ...
          <div class="col-span-2 sm:col-span-1">
           <p class="text-white">
            Ziro is a Freelance Landing Website lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
           </p>
          </div>
          ...
          <ul class="col-span-2 flex justify-start gap-6 lg:col-span-5 ">
            <li>
              <a
                href="#"
                rel="noreferrer"
      ...
      <div class="mt-8 border-t border-gray-100 pt-8">
        <div class="sm:flex sm:justify-between">
            <p class="text-xs text-white">
                &copy; <span id="currentYear"></span>. Company Name. All rights reserved.
              </p>
